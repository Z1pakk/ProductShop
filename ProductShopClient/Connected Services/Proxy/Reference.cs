...
namespace ProductShopClient.Proxy {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Account", Namespace="http://schemas.datacontract.org/2004/07/ProductShopLibrary")]
    ...
    public interface IAccountService {
        ...
        void Register(ProductShopClient.Proxy.Account account, string password);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/Register", ReplyAction="http://tempuri.org/IAccountService/RegisterResponse")]
        System.Threading.Tasks.Task RegisterAsync(ProductShopClient.Proxy.Account account, string password);
        ...
        ProductShopClient.Proxy.Account GetInfo(string token);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/GetInfo", ReplyAction="http://tempuri.org/IAccountService/GetInfoResponse")]
        System.Threading.Tasks.Task<ProductShopClient.Proxy.Account> GetInfoAsync(string token);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccountServiceChannel : ProductShopClient.Proxy.IAccountService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountServiceClient : System.ServiceModel.ClientBase<ProductShopClient.Proxy.IAccountService>, ProductShopClient.Proxy.IAccountService {
        ...
        public void Register(ProductShopClient.Proxy.Account account, string password) {
            base.Channel.Register(account, password);
        }
        
        public System.Threading.Tasks.Task RegisterAsync(ProductShopClient.Proxy.Account account, string password) {
            return base.Channel.RegisterAsync(account, password);
        }
        
        public ProductShopClient.Proxy.Account GetInfo(string token) {
            return base.Channel.GetInfo(token);
        }
        
        public System.Threading.Tasks.Task<ProductShopClient.Proxy.Account> GetInfoAsync(string token) {
